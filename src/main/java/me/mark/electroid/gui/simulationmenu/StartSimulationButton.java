...
public class StartSimulationButton extends Button implements UpdatableComponent, Hoverable, CenteredComponent {

  private boolean disabled;
  private final static Color COLOR_ENABLED = new Color(45, 255, 100);
  private final static Color COLOR_DISABLED = new Color(100, 100, 100);
  private boolean hovered;
  private static final int BORDER_WIDTH = 5;

  public StartSimulationButton(Location loc) {
    super(loc, 120, 30, "START", SimulationMenu.BUTTON_FONT, Color.BLACK, 5, false);
    this.disabled = false;
