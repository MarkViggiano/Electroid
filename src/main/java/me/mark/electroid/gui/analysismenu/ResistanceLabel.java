...
public class ResistanceLabel extends TextComponent implements UpdatableComponent {

  public ResistanceLabel(Location loc) {
  ...
  public void updateComponent(ElectricalComponent component) {
    setText(component.getResistance() + " ohms");
  }
