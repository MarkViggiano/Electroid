...
public class Material extends com.megaboost.items.Material {
  ...
  public static final Material VOLTAGE_SOURCE = new Material("Voltage Source", 5, Electroid.getInstance().getComponentSheet().getImageFromPosition(7,0), false);
  public static final Material RESISTOR = new Material("Resistor", 6, Electroid.getInstance().getComponentSheet().getImageFromPosition(2,0), false);
